...
ex1 = function (x, y) {
    return Maybe.of(x).map(add).ap(Maybe.of(y));
};
...
//getPost & getComments return a Task

var n = 3;
ex3 = liftA2(render, getPost(n), getComments(n));
ex3 = Task.of(render).ap(getPost(n)).ap(getComments(n));
...
//  ex4 :: IO String
var ex4 = undefined;
ex4 = liftA2(game, getCache('player1'), getCache('player2'));
ex4 = IO.of(game).ap(getCache('player1')).ap(getCache('player2'));
